...
import { Calendar04Icon, ArrowDown01Icon } from "@hugeicons/core-free-icons"
    ...
    <Popover>
      <PopoverTrigger>
        ...
        >
          ...
          <HugeiconsIcon icon={Calendar04Icon} strokeWidth={2} aria-hidden="true" className="text-muted-foreground/80 group-hover:text-foreground shrink-0 transition-colors" />
        </Button>
      </PopoverTrigger>
                ...
                {selectedYear === null ? (
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex items-center gap-2">
                      ...
                      >
                        <HugeiconsIcon icon={ArrowDown01Icon} strokeWidth={2} className="mr-1 size-4 rotate-90" />
                        {selectedYear}
                      </Button>
                    </div>
...
function CaptionLabel({
  ...
  return (
    ...
    >
      {children}
      <HugeiconsIcon icon={ArrowDown01Icon} strokeWidth={2} aria-hidden="true" className="text-muted-foreground/80 shrink-0 transition-transform duration-200" />
    </Button>
  )
}