...
import { MoreHorizontalCircle01Icon, Alert02Icon } from "@hugeicons/core-free-icons"
...
function PriorityGlyph({
  ...
  switch (tone) {
    case "none":
      return (
        <HugeiconsIcon icon={MoreHorizontalCircle01Icon} strokeWidth={2} className={cn(
    ...
    case "urgent":
      return (
        <HugeiconsIcon icon={Alert02Icon} strokeWidth={2} className={cn(
